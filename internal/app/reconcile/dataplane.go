...
func (r *DataPlaneReconciler) reconcileDependentObject(ctx context.Context, object domain.NetworkObject) error {
	if (object.Kind != domain.NetworkSwitchL2 && object.Kind != domain.NetworkSwitchL3) || r.networkObjects == nil {
		return nil
	}
